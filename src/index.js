import { FloatType, PMREMGenerator, Scene, PerspectiveCamera, WebGLRenderer, Color, Vector2, BoxGeometry, ACESFilmicToneMapping, sRGBEncoding, Mesh, TextureLoader, CylinderGeometry, PCFSoftShadowMap, MeshPhysicalMaterial, PointLight, DoubleSide, SphereGeometry, MeshStandardMaterial} from 'https://cdn.skypack.dev/three@0.137';
...
function clouds() {
    ...
    for(let i = 0; i < count; i++) {
        ...
        const puff2 = new SphereGeometry(1.5, 12, 12);
